...
try:
    ...
    target_quat = orientation_result["orientation"]
    ...
    print("\nTRAJECTORY POINTS:")
    print(len(plan.trajectory.joint_trajectory.points))
    ...
    print("\nTCP ERROR:")
    print(float(np.linalg.norm(TARGET - final_tcp)))
