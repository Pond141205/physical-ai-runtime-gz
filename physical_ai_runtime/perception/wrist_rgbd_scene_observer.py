...
class WristRGBDSceneObserver(Node):
    ...
    def __init__(
        ...
        super().__init__("wrist_rgbd_scene_observer")

        self.query = query
        self.robot_frame = robot_frame

        # Sensor frame and TF geometry frame are intentionally
        # different in Gazebo. CameraInfo identifies the sensor,
        # while geometry uses the URDF optical frame.
        self.sensor_frame = None
        self.camera_frame = "panda_wrist_camera_optical_frame"
